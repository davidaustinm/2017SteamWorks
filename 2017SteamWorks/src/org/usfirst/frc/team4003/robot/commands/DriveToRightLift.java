...
public class DriveToRightLift extends CommandGroup {
    ...
    public DriveToRightLift() {
    	if(Robot.sensors.isAllianceColorRed()){
    		addSequential(new DriveToPoint(60, 0, new Acceleration(.2, .5, 0.02), true, 15));
        	...
        	addSequential(new DriveBackToPoint(170, 30, new Acceleration(.2, .4, 0.02), true, 20));
        	addSequential(new RotateToHeading(-90, 0, 0.4));
        	//addSequential(new DriveForwardForDistance(10, 0.3));
        	addSequential(new SwitchDirection());
    	} else {
        	addSequential(new DriveToPoint(60, 0, new Acceleration(.2, .55, 0.02), true, 15));
        	...
        	addSequential(new DriveBackToPoint(155, -30, new Acceleration(.2, .55, 0.02), true, 20));
